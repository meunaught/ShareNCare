 ...
 * Use the [My_followersFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class My_followersFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var recyclerview : RecyclerView?= null
    private var userAdapter : My_FollowersAdapter? = null
    private var mUser : MutableList<User>?= null
    private var sUser : MutableList<User> = ArrayList()
    private var followingList : MutableList<User>?= null
    private lateinit var search_editText_my_followers_fragment : EditText
    ...
    override fun onCreateView(
        ...
        search_editText_my_followers_fragment = view.findViewById(R.id.search_editText_my_followers_fragment)
        recyclerview = view.findViewById(R.id.recycler_view_my_followers_fragment)
        recyclerview?.setHasFixedSize(true)
        recyclerview?.layoutManager = LinearLayoutManager(context)

        mUser = ArrayList()
        userAdapter = context?.let { My_FollowersAdapter(it,mUser as ArrayList<User>,true) }
        userAdapter?.setHasStableIds(true)
        recyclerview?.adapter = userAdapter
        recyclerview?.setItemViewCacheSize(15)
        checkFollowers()

        search_editText_my_followers_fragment.addTextChangedListener(object : TextWatcher
        {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                if(search_editText_my_followers_fragment.text.toString()== "")
                {
                    mUser?.clear()
                    for(user in sUser)
                    {
    ...
    companion object {
         ...
         * @return A new instance of fragment My_followersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            My_followersFragment().apply {
