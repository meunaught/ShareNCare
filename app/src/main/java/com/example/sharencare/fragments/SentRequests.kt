 ...
 * Use the [SentRequests.newInstance] factory method to
...
class SentRequests : Fragment() {
    ...
    private var userAdapter : Sent_RequestsAdapter? = null
    private var mUser : MutableList<User>?= null
    private var sUser : MutableList<User> = ArrayList()
    private var sentRequestsList : MutableList<User>?= null
    private lateinit var search_editText_sent_requests_fragment : EditText
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_sent_requests, container, false)
        ...
        search_editText_sent_requests_fragment.addTextChangedListener(object : TextWatcher
        {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                if(search_editText_sent_requests_fragment.text.toString()== "")
                {
                    mUser?.clear()
                    for(user in sUser)
                    {
